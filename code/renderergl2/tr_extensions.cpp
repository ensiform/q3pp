...
void GLimp_InitExtraExtensions()
{
	...
	{
		qglDrawRangeElementsEXT = ( void( APIENTRYP ) ( GLenum, GLuint, GLuint, GLsizei, GLenum, const GLvoid * ) ) SDL_GL_GetProcAddress("glDrawRangeElementsEXT");
	...
	if( GLimp_HaveExtension( extension ) )
	{
		qglDrawBuffersARB = ( void( APIENTRYP ) ( GLsizei, const GLenum * ) ) SDL_GL_GetProcAddress("glDrawBuffersARB");
	...
	if( GLimp_HaveExtension( extension ) )
	{
		if (r_arb_seamless_cube_map->integer)
			glRefConfig.seamlessCubeMap = true;
