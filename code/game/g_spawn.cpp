...
void SP_worldspawn( void ) {
	...
	trap->SetConfigstring( CS_MUSIC, s );

	G_SpawnString( "message", "", &s );
	trap->SetConfigstring( CS_MESSAGE, s );				// map specific message

	trap->SetConfigstring( CS_MOTD, g_motd.string );		// message of the day

	G_SpawnString( "gravity", "800", &s );
	cvarSystem->Set( "g_gravity", s );

	G_SpawnString( "enableDust", "0", &s );
	cvarSystem->Set( "g_enableDust", s );

	G_SpawnString( "enableBreath", "0", &s );
	cvarSystem->Set( "g_enableBreath", s );
