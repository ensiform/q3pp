...
*/
static
sfxHandle_t S_AL_RegisterSound( const char *sample, bool compressed )
{
...
static void S_AL_SrcSetup(srcHandle_t src, sfxHandle_t sfx, alSrcPriority_t priority,
		int entity, int channel, bool local)
{
	src_t *curSource;
...
*/
static
void S_AL_ClearLoopingSounds( bool killall )
{
	int i;
	for(i = 0; i < srcCount; i++)
	{
